                    ...
                    <form action="{{ route('admin.hasil-panen.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            @if (auth()->user()->roles == 'admin')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <input type="text" name="url_lokasi" id="url_lokasi" class="form-control shadow-sm mb-3" placeholder="URL Lokasi (Gmaps)" required>
                                    </div>
                                </div>
                            @else
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    ...
                                    <div class="input-group mb-3 shadow-sm">
                                        <input type="date" name="tgl_tanam" id="" class="form-control" placeholder="Tanggal Tanam" aria-label="Tanggal Tanam" required aria-describedby="basic-addon2">
                                    </div>
                                </div>
                                <div class="col-md">
                                    <label for="tgl_panen">Tanggal Panen</label>
                                    <div class="input-group mb-3 shadow-sm">
                                        <input type="date" name="tgl_panen" id="" class="form-control" placeholder="Tanggal Panen" aria-label="Tanggal Panen" required aria-describedby="basic-addon2">
                                    </div>
                                </div>
                                <div class="col-md">
                        ...
                        {{-- <div class="row">
                            <div class="col-md">
                                ...
                                <select name="penyuluh_id" id="penyuluh_id" class="custom-select shadow-sm mb-3" required>
